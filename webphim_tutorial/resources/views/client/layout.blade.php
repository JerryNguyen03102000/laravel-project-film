...
<head>
    ...
    <link rel='stylesheet' id='wp-block-library-css' href='{{asset('client/css/style.min.css?ver=5.7.2')}}'/>
    <link rel='stylesheet' id='wp-block-library-css' href='{{asset('client/css/custom.css')}}' media='all'/>
            ...
            <div class="col-md-3 col-sm-6 slogan">
                <p class="site-title">
                    <a class="logo" href="" title="phim hay ">
                        <img src="{{asset('client/images/logo2.png')}}" alt="error_img">
                    </a>
                </p>
            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            <div class="input-group col-xs-12">
                                ...
                                <i class="fa-sharp fa-solid fa-magnifying-glass hidden"></i>
                            </div>
                            <div class="result-div">
                                <ul  class="list-group" class="result" id="result">
                                </ul>
                            </div>
                        </div>
                    ...
                    <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($genres as $key => $genre)
                                    <li><a title="{{$genre->title}}"
                                           href="{{route('genre',['slug'=>$genre->slug])}}">{{$genre->title}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                        <li class="mega dropdown">
                        ...
                        @foreach($categories as $key => $cate)
                            <li class="mega"><a title="{{$cate->title}}"
                                                href="{{route('category',['slug'=>$cate->slug])}}">{{$cate->title}}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
...
<script type='text/javascript' src='{{asset('client/js/jquery.min.js?ver=5.7.2')}}' id='carousel-js'></script>
<script type='text/javascript' src='{{asset('client/js/halimtheme-core.min.js?ver=1626273138')}}'
